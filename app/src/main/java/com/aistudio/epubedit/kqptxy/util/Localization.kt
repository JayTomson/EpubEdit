...
object Loc {
    private val ru = mapOf(
        ...
        "convert_epub_system_desc" to "Конвертировать главы в упрощённый формат тегов. Если отключено, сохраняется оригинальный XHTML/CSS со всеми стилями книги. Изменения названия/автора книги могут не попасть в файл в этом режиме.",
    ...
    private val en = mapOf(
        ...
        "convert_epub_system_desc" to "Convert chapters into a simplified tag list. If turned off, preserves the original XHTML/CSS with all book styles. Title/author changes may not be saved to file in this mode.",
